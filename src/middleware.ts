...
export async function middleware(request: NextRequest) {
    ...
    try {
        ...
        // 5. Forward verified identity to protected route handlers. Response
        // headers are sent to the browser, so they are not visible through
        // request.headers in API route handlers.
